...
class ImportUsers extends Command
{
    ...
    {
        try {
            $csv = Reader::createFromPath(storage_path('app/public/profiles1.csv'), 'r');
            ...
            foreach ($csv as $record) {
                ...
                $gender_id = !empty($record['gender_id']) && is_numeric($record['gender_id']) ? intval($record['gender_id']) : null;
                ...
                try {
                    ...
                    $user = User::updateOrCreate(
                        ...
                        [
                            ...
                            'original_email' => $record['orig                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  inal_email'] ?? null,
                    ...
                    if (isset($record['educations']) && !empty($record['educations'])) {
                        ...
                        foreach ($educations as $education) {
                            ...
                            ProfileEducation::updateOrCreate(
                                [
                                    'user_id' => $user->id,
                                    'degree_title' => $isValidDegreeTitle ? substr($education['description'], 0, 255) : null,
                    ...
                    if (isset($record['experiences']) && !empty($record['experiences'])) {
                        $experiences = json_decode($record['experiences'], true);
                        foreach ($experiences as $experience) {
                            ProfileExperience::updateOrCreate(
                                [
                                    'user_id' => $user->id,
                                    'title' => $experience['position'] ?? null,
                                    'company' => $experience['company'] ?? null,
                                    'date_start' => isset($experience['start_date']) ? Carbon::parse($experience['start_date']) : null,
                                    'date_end' => isset($experience['end_date']) ? Carbon::parse($experience['end_date']) : null,
                                ],
                                [
                                    'country_id' => $experience['country_id'] ?? null,
                                    'state_id' => $experience['state_id'] ?? null,
                    ...
                    Log::error("Error importing user: " . $e->getMessage(), ['record' => $record]);
                }
            }
