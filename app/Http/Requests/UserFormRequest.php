...
class UserFormRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
           ...
           // 'career_level_id' => 'required',
            ...
            'image' => 'image|max:5120|mimes:jpeg,png,jpg,gif',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'password.min' => 'The password should be more than 5 characters long.',
           ...
           // 'mobile_num.required' => 'Please enter mobile number',
            ...
            'expected_salary.gt' => __('Should be greater than current salary'),
        ];
    }
