...
use App\Http\Middleware\EnsureCompanyUserIsAdmin;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'admin' => RedirectIfAdminNotAuthenticated::class,
        'admin.guest' => RedirectIfAdminAuthenticated::class,
        'checkAdminRoles' => CheckAdminRole::class,
        'company' => RedirectIfCompanyNotAuthenticated::class,
        'company.guest' => RedirectIfCompanyAuthenticated::class,
        'company.admin' => EnsureCompanyUserIsAdmin::class,
    ];
