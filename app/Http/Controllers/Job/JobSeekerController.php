...
//        /*         * ************************************************** */
//
//        $jobSeekerIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.id');
//
//        /*         * ************************************************** */
//
...
//        /*         * ************************************************** */
//
//        $countryIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.country_id');
//
//        /*         * ************************************************** */
//
//        $stateIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.state_id');
//
//        /*         * ************************************************** */
//
//        $cityIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.city_id');
//
//        /*         * ************************************************** */
//
//        $industryIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.industry_id');
//
//        /*         * ************************************************** */
//
//
//        /*         * ************************************************** */
//
//        $functionalAreaIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.functional_area_id');
//
//        /*         * ************************************************** */
//
//        $careerLevelIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.career_level_id');
//
//        /*         * ************************************************** */
//
//        $genderIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.gender_id');
//
//        /*         * ************************************************** */
//
//        $jobExperienceIdsArray = $this->fetchIdsArray($search, $industry_ids, $functional_area_ids, $country_ids, $state_ids, $city_ids, $job_skill_ids, $career_level_ids, $gender_ids, $job_experience_ids, $current_salary, $expected_salary, $salary_currency, 'users.job_experience_id');
//
//        /*         * ************************************************** */
//
...
//
//        $jobExperienceIdsArrayNew = $data['job_experience']->pluck('job_experience_id')->toArray();
...
//                        ->with('jobExperienceIdsArray', $jobExperienceIdsArrayNew)
//                        ->with('data',$data)
//                        ->with('seo', $seo);
//    }
    public function jobSeekersBySearch(Request $request)
    {
        $search = $request->query('search', '');
        $job_title_filter = $request->query('job_title_filter', ''); // Get the value from textbox

        // If a skill/title is selected in the textbox, we can append it to the search or handle it specifically
        if (!empty($job_title_filter)) {
            $search = $job_title_filter;
        }
        $functional_area_ids = $request->query('functional_area_id', array());
        $country_ids = $request->query('country_id', array());
        $state_ids = $request->query('state_id', array());
