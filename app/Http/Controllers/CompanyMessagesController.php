...
class CompanyMessagesController extends Controller
{
    ...
    function submitnew_message_seeker(Request $request)
    {
        ...
        $message->company_id = Auth::guard('company')->user()->company->id;
        $message->message = $request->message;
        $message->seeker_id = $request->seeker_id;
        $message->type = 'reply';
        $message->save();

        $company = Company::where('id', Auth::guard('company')->user()->company->id)->first();
    ...
    public function all_messages()
    {
        ...
        $messages = CompanyMessage::where('company_id', Auth::guard('company')->user()->company->id)->get();
        $ids = array();
