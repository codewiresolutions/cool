...
class PackageController extends Controller
{
    ...
    public function storePackage(PackageFormRequest $request)
    {
        ...
        $package->package_resume_downloads = $request->input('package_resume_downloads');
        $package->package_cv_searches = $request->input('package_cv_searches');
        $package->package_users_limit = $request->input('package_users_limit');
