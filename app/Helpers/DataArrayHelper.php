...
class DataArrayHelper
{
    ...
    {
        $array = State::select('states.state', 'states.state_id')->where('states.country_id', '=', $country_id)->isDefault()->active()->orderBy('state','ASC')->pluck('states.state', 'states.state_id')->toArray();
        return $array;
    }
    ...
    {
        $array = City::select('cities.city', 'cities.city_id')->where('cities.state_id', '=', $state_id)->isDefault()->active()->orderBy('city','ASC')->pluck('cities.city', 'cities.city_id')->toArray();
        return $array;
    }
    ...
    {
        $array = State::select('states.state', 'states.state_id')->where('states.country_id', '=', $country_id)->lang()->active()->orderBy('state','ASC')->pluck('states.state', 'states.state_id')->toArray();
    ...
    {
        $array = City::select('cities.city', 'cities.city_id')->where('cities.state_id', '=', $state_id)->lang()->active()->orderBy('city','ASC')->pluck('cities.city', 'cities.city_id')->toArray();
        if ((int) count($array) === 0) {
    ...
    {
        $array = Country::select('countries.nationality', 'countries.country_id')->isDefault()->active()->orderBy('country','ASC')->pluck('countries.nationality', 'countries.country_id')->toArray();
        return $array;
    }

    public static function langNationalitiesArray()
    {
        $array = Country::select('countries.nationality', 'countries.country_id')->lang()->active()->orderBy('country','ASC')->pluck('countries.nationality', 'countries.country_id')->toArray();
        if ((int) count($array) === 0) {
    ...
    {
        $array = Country::select('countries.country', 'countries.country_id')->isDefault()->active()->orderBy('country','ASC')->pluck('countries.country', 'countries.country_id')->toArray();
        return $array;
    }

    public static function langCountriesArray()
    {
        $array = Country::select('countries.country', 'countries.country_id')->lang()->active()->orderBy('country','ASC')->pluck('countries.country', 'countries.country_id')->toArray();
        if ((int) count($array) === 0) {
