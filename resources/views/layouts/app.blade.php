...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-FQ399KQ8ED"></script>
    <script>
...
<script>
    var botmanWidget = {
        bubbleAvatarUrl: 'https://freesvg.org/img/1538298822.png',
        bubbleBackground: 'white',
        title: 'Recruitment Agent',
        bubble: false,
        desktopHeight: 500,
        desktopWidth: 400,
        introMessage: 'Hello! 👋 Welcome to Coolbuffs recruitment site Im JobBot, here to assist you with job opportunities, job applicants, and any questions you might have. Please choose from the following options'
    };
</script>
...
<script type="text/JavaScript">
    ...
    $(document).on('turbolinks:load', function () {
        if ($.fn.countrySelect) {
            ...
            console.error('countrySelect plugin not loaded');
        }
        // defaultCountry: "qa",
