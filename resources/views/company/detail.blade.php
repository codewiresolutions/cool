    ...
    <div class="listpgWraper">
        ...
        <div class="container">
            ...
            <div class="job-header">
                ...
                <!-- Buttons -->
                @php
                    $isOwnCompany = Auth::guard('company')->check() && Auth::guard('company')->user()->company->id == $company->id;
                @endphp
                ...
                @if (!$isOwnCompany)
                    <div class="jobButtons">
                        ...
                        <a href="{{ route('report.abuse.company', $company->slug) }}" class="btn report">
                            <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> {{ __('Submit Suggestions') }}
                        </a>
                            ...
                            @if(isset($company->jobs) && count($company->jobs))
                                ...
                                @foreach($company->jobs as $companyJob)
                                    ...
                                    <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                ...
                                                <div class="jobimg"><a
                                                            ...
                                                            title="{{$companyJob->title}}"> {{$company->printCompanyImage()}} </a>
                                                </div>
                                        ...
                                        <p>{{Str::limit(strip_tags($companyJob->description), 150, '...')}}</p>
