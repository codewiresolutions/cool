...
@section('content')
    ...
    <section id="blog-content">
        ...
        <div class="container">
            ...
            <div class="row blog-filter-row my-4">
                <div class="col-lg-12">
                    <!-- FILTER CARD -->
                    <div class="blog-filter-card">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-4">
                                @if(isset($blogs_categories) && $blogs_categories->count())
                                    <div class="blog-category-widget">
                                        <select class="form-control blog-category-dropdown"
                                                onchange="if(this.value) window.location.href=this.value;">
                                            <option value="">Select Category</option>

                                            @foreach($blogs_categories as $cat)
                                                <option value="{{ url('/blog/category/'.$cat->slug) }}">
                                                    {{ $cat->heading }}
                                                </option>
                                            @endforeach
                            ...
                            @if(null!==($blogs))
                                ...
                                @foreach($blogs as $blog)
                                    ...
                                    <li class="col-lg-4 mb-4">
                                        <div class="blog-card">
                                            <div class="blog-img">{{$blog->printBlogImage()}}</div>
