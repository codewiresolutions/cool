                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="formrow{{ $errors->has('cv_id') ? ' has-error' : '' }}"> {!! Form::select('cv_id', [''=>__('Select CV ')]+$myCvs, null, array('required'=>'required','class'=>'form-control', 'id'=>'cv_id')) !!}
                                        @if ($errors->has('cv_id'))
                                            <span class="help-block"> <strong>{{ $errors->first('cv_id') }}</strong> </span>
                                        @endif </div>
                                </div>
                                <div class="col-md-6">
                                    <h5>Current Salary</h5>
                                    <div class="formrow{{ $errors->has('current_salary') ? ' has-error' : '' }}"> {!! Form::number('current_salary', null, array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>__('Enter Current CTC ').' ('.$job->getSalaryPeriod('salary_period').')', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" )) !!}
                                        @if ($errors->has('current_salary'))
                                            <span class="help-block"> <strong>{{ $errors->first('current_salary') }}</strong> </span>
                                        @endif </div>
                                </div>
                                <div class="col-md-6">
                                    <h5>Expected Salary</h5>
                                    <div class="formrow{{ $errors->has('expected_salary') ? ' has-error' : '' }}"> {!! Form::number('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('Enter Expected CTC').' ('.$job->getSalaryPeriod('salary_period').')', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');")) !!}
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    @if ($errors->has('salary_currency'))
                                        <span class="help-block"> <strong>{{ $errors->first('salary_currency') }}</strong> </span>
                                    @endif </div> -->
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="hidden" class="form-control"
                                                               name="question_answers[<?php echo $key;?>][question]"
                                                               value="<?php echo $question->question;?>"/>
                                                        <input type="hidden" class="form-control"
                                                               name="question_answers[<?php echo $key;?>][question_type]"
                                                               value="<?php echo $question->question_type;?>"/>
                                                            <?php
                                                        if ($question->question_type == "text") { ?>
                                                        <input type="text" class="form-control"
                                                               name="question_answers[<?php echo $key;?>][answer]"
                                                               maxlength="10000" required/>
                                                            <?php
                                                        } else if ($question->question_type == "video") { ?>
                                                        <input type="file" class="form-control"
                                                               name="question_answers_files[<?php echo $key;?>]"
                                                               required onchange="checkextension(this)"/>
                                                            <?php
                                                        }
                                                            ?>
                                                    </div>
