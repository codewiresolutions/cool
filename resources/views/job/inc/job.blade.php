...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
            <label class='bold'>Salary Period</label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'current_location_id') !!}"
             id="current_location_id_div">
    ...
    <div class="col-sm-10">
        ...
        <div class="row dynamic_questions_container" id="dynamic_questions_container">
            <div class="col-md-10" style="margin-top: 0px; margin-bottom: 15px;">
                <button type="button" class="btn btn-success mt-0" onClick="return addQuestionsRow()"><i
                            class="fa fa-plus"></i> Add new Question
                </button>
            </div>
    ...
    <div class="col-md-12">
        <div class="formrow">
            <button type="button" onclick="submitJob()" class="btn">{{__('SUBMIT')}} <i class="fa fa-arrow-circle-right"
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function filterLangStates(state_id) {
            ...
            if (country_id != '') {
                $.post("{{ route('filter.lang.states.dropdown.job') }}", {
        ...
        function filterLangCities(city_id) {
            ...
            if (state_id != '') {
                $.post("{{ route('filter.lang.cities.dropdown.job') }}", {
                    state_id: state_id,
                    city_id: city_id,
                    _method: 'POST',
                    _token: '{{ csrf_token() }}'
