            ...
            <div class="row">
                    ...
                    <div class="job-header">
                        <div class="jobinfo">
                            ...
                            @if(!Auth::user() && !Auth::guard('company')->user())
                                <a href="{{route('login')}}"><i class="fa fa-sign-in"
                                                                aria-hidden="true"></i> {{__('Login to View Salary')}}
                                </a>
                            @else
                            ...
                            <div class="jobdetail">
                                ...
                                <ul class="jbdetail">
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-md-8 col-xs-7">
                                            <span>{{$job->getCareerLevel('career_level')}}</span></div>
                                    </li>
                                    <li class="row">
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-md-8 col-xs-7">
                                            <span>{{$job->getJobExperience('job_experience')}}</span></div>
                                    </li>
                                    <li class="row">
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-md-8 col-xs-7">
                                            <span>{{$job->expiry_date->format('M d, Y')}}</span></div>
                                    </li>
                                    ...
                                    if (Auth::check() && Auth::user()->isAppliedOnJob($job->id)) {
                                        $data = Auth::user()->getAppliedOnJobDetails($job->id);
                                        if ($data != '') {
                                            $JSON = json_decode($data->data);
                                            if (count($JSON) > 0) {
                                                $user_given_answers = $JSON;
                                            }
                                        }
                                    }
                                    $all_questions = "";
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                                ...
                                                                <?php
                                                            if (isset($user_given_answers[$key]) && $user_given_answers[$key] != '') {
                                                            if (isset($question->question_type) && $question->question_type == "text") {
                                                                echo "<p style='word-break: break-all;'>" . $user_given_answers[$key]->answer . "</p>";
                                                            } else if (isset($question->question_type) && $question->question_type == "video") {
                                                                ?>
                                                            <video width="320" height="240" controls>
                                                                <source src="<?php echo asset('question_answer_videos')."/".$user_given_answers[$key]->video_name;?>"
                                                                        type="video/mp4">
                                                            </video>
                                                                <?php
                                                            }
                        ...
                        <div class="jobButtons">
                            <a href="{{route('email.to.friend', $job->slug)}}" class="btn"><i class="fa fa-envelope"
                                                                                              aria-hidden="true"></i> {{__('Email to Friend')}}
                            </a>
                            ...
                            <a href="{{route('report.abuse', $job->slug)}}" class="btn report"><i
                                        ...
                                        aria-hidden="true"></i> {{__('Submit Suggestions')}}</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="jobButtons applybox">
                        ...
                        @elseif(Auth::check() && Auth::user()->isAppliedOnJob($job->id))
                            <a href="javascript:" class="btn apply applied"><i class="fa fa-paper-plane"
                                                                               aria-hidden="true"></i> {{__('Already Applied')}}
                            </a>
                        @else
                            ...
                            @else
                                <a href="{{route('apply.job', $job->slug)}}" class="btn apply"><i
                                            class="fa fa-paper-plane" aria-hidden="true"></i> {{__('Apply Now')}}</a>
                            @endif
                    ...
                    <div class="companyinfo">
                        ...
                        <div class="title"><a href="{{route('company.detail',$company->slug)}}">{{$company->name}}</a>
                        </div>
                        ...
                        <div class="companyoverview">
                            ...
                            <p>{{Str::limit(strip_tags($company->description), 250, '...')}} <a
