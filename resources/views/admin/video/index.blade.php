...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Video languages</h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="videoDatatableAjax">
                                    <thead>                                        
                                        <tr role="row" class="filter">
                                            {{-- <td>{!! Form::select('lang', ['' => 'Select Language']+$languages, null, array('id'=>'lang', 'class'=>'form-control')) !!}</td> --}}
                                            <td><input type="text" class="form-control" name="video_title" id="video_title" autocomplete="off" placeholder="Video Title"></td>
