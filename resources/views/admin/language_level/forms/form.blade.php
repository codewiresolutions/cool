...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'language_level') !!}">
        {!! Form::label('language_level', 'Language Level', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'language_level_id') !!}" id="language_level_id_div">
        {!! Form::label('language_level_id', 'Default Language Level', ['class' => 'bold']) !!}                    
        {!! Form::select('language_level_id', ['' => 'Select Default Language Level']+$languageLevels, null, array('class'=>'form-control', 'id'=>'language_level_id')) !!}
