...
<div class="form-body">    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'first_name') !!}">
        {!! Form::label('first_name', 'First Name', ['class' => 'bold']) !!}  <font style="color:red;">*</font>                  
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'last_name') !!}">
        {!! Form::label('last_name', 'Last Name', ['class' => 'bold']) !!}   <font style="color:red;">*</font>                  
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'email') !!}">
        {!! Form::label('email', 'Email', ['class' => 'bold']) !!} <font style="color:red;">*</font>                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'password') !!}">
        {!! Form::label('password', 'Password', ['class' => 'bold']) !!}   <font style="color:red;">*</font>                  
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
        {!! Form::label('date_of_birth', 'Date of Birth', ['class' => 'bold']) !!} <font style="color:red;">*</font>                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
        {!! Form::label('nationality_id', 'Nationality', ['class' => 'bold']) !!}  <font style="color:red;">*</font>                   
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'phone') !!}">
        {!! Form::label('phone', 'Phone', ['class' => 'bold']) !!}  <font style="color:red;">*</font>                   
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
        {!! Form::label('industry_id', 'Industry', ['class' => 'bold']) !!} <font style="color:red;">*</font>                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
        {!! Form::label('current_salary', 'Current Salary', ['class' => 'bold']) !!}  <font style="color:red;">*</font>                   
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
        {!! Form::label('expected_salary', 'Expected Salary', ['class' => 'bold']) !!}   <font style="color:red;">*</font>                  
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
        {!! Form::label('street_address', 'Street Address', ['class' => 'bold']) !!}  <font style="color:red;">*</font>                   
