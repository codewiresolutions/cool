        ...
        <div class="col-md-12">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption"><i class=" icon-layers font-green"></i> <span
                                class="caption-subject font-green bold uppercase">Education</span></div>
                </div>
                <div class="portlet-body">
                    <div class="row" id="education_div"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function delete_profile_education(id) {
            if (confirm('Are you sure! you want to delete?')) {
                $.post("{{ route('delete.profile.education') }}", {
                    id: id,
                    _method: 'DELETE',
                    _token: '{{ csrf_token() }}'
                })
        ...
        function showEducation() {
            $.post("{{ route('show.profile.education', $user->id) }}", {
                user_id: {{$user->id}},
                _method: 'POST',
                _token: '{{ csrf_token() }}'
            })
