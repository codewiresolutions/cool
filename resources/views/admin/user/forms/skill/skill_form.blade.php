<div class="modal-body">
    <div class="form-body">
        <div class="form-group" id="div_job_skill_id">
            ...
            ?>
            {!! Form::select('job_experience_id', $jobExperiences, $job_experience_id, array('class'=>'form-control select2-multiple', 'id'=>'job_experience_id','multiple'=>'multiple')) !!} <span class="help-block job_experience_id-error"></span> </div>
    </div>
</div>
<script>
