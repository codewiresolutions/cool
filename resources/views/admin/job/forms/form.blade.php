...
<div class="row">
    ...
    <div class="col-md-2 form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}"
         id="salary_currency_div">
    ...
    <div class="col-md-2 form-group {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}"
         id="salary_period_id_div">
...
<div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
    {!! Form::label('job_experience_id', 'Required job experience', ['class' => 'bold']) !!} <font
...
<div class="form-group">
    ...
    <div class="row dynamic_questions_container" id="dynamic_questions_container">
        ...
        <div class="col-md-12" style="margin-top: 12px; margin-bottom: 15px;">
            <button type="button" class="btn btn-success" onClick="return addQuestionsRow()"><i class="fa fa-plus"></i>
                Add new Question
            </button>
        </div>
            ...
            <div class="each_question_container question_no_<?php echo $key;?>">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-control" name="questions[<?php echo $key;?>][question_type]" required>
                        <option value="text" <?php if ($question->question_type == "text") {
                            echo "selected";
                        } ?>>Text
                        </option>
                        <option value="video" <?php if ($question->question_type == "video") {
                            echo "selected";
                        } ?>>Video
                        </option>
                    </select>
                ...
                <div class="col-md-5">
                    ...
                    <input class="form-control" type="text" maxlength="2000"
                           name="questions[<?php echo $key;?>][question]" value="<?php echo $question->question;?>"
                           placeholder="Enter your question here..." required/>
                </div>
                <div class="col-md-2" style="padding-left: 0;">
                    <label>&nbsp;</label>
                    <span class="delete_question" onclick="delete_question(<?php echo $key;?>)"><i
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function filterDefaultSubjects(subject_id) {
            ...
            if (degree_level_id != '') {
                $.post("{{ route('filter.default.subject.dropdown.job') }}", {
        ...
        function filterDefaultStates(state_id) {
            ...
            if (country_id != '') {
                $.post("{{ route('filter.default.states.dropdown.job') }}", {
        ...
        function filterDefaultCities(city_id) {
            ...
            if (state_id != '') {
                $.post("{{ route('filter.default.cities.dropdown.job') }}", {
                    state_id: state_id,
                    city_id: city_id,
                    _method: 'POST',
                    _token: '{{ csrf_token() }}'
