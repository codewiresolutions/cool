                                ...
                                <table class="table table-striped table-bordered table-hover"  id="jobDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            <td>{!! Form::select('company_id', ['' => 'All Companies']+$companies, null, array('id'=>'company_id', 'class'=>'form-control')) !!}</td>
                                            ...
                                            <td>
                                                <?php 
                                                    // $default_country_id = Request::query('country_id', $siteSetting->default_country_id);
                                                $default_country_id = "";
                                                ?>
                                                {!! Form::select('country_id', ['' => 'All Countries']+$countries, $default_country_id, array('id'=>'country_id', 'class'=>'form-control')) !!}
                                                <span id="default_state_dd">
                                                    {!! Form::select('state_id', ['' => 'All States'], null, array('id'=>'state_id', 'class'=>'form-control')) !!}
                                                </span>
                                                <span id="default_city_dd">
                                                    {!! Form::select('city_id', ['' => 'All Cities'], null, array('id'=>'city_id', 'class'=>'form-control')) !!}
                                                </span></td>
