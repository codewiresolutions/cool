...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_period') !!}">
        ...
        {!! Form::text('salary_period', null, array('class'=>'form-control', 'id'=>'salary_period', 'placeholder'=>'Salary Period', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
        {!! Form::label('salary_period_id', 'Default Salary Period', ['class' => 'bold']) !!}                    
        {!! Form::select('salary_period_id', ['' => 'Select Default Salary Period']+$salaryPeriods, null, array('class'=>'form-control', 'id'=>'salary_period_id')) !!}
