...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_skill') !!}">
        {!! Form::label('job_skill', 'Job Skill', ['class' => 'bold']) !!}                    
        {!! Form::text('job_skill', null, array('class'=>'form-control', 'id'=>'job_skill', 'placeholder'=>'Job Skill', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_skill_id') !!}" id="job_skill_id_div">
        {!! Form::label('job_skill_id', 'Default Job Skill', ['class' => 'bold']) !!}                    
        {!! Form::select('job_skill_id', ['' => 'Select Default Job Skill']+$jobSkills, null, array('class'=>'form-control', 'id'=>'job_skill_id')) !!}
