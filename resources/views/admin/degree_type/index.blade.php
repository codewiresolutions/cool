...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Degree Types</h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="degreeTypeDatatableAjax">
                                    <thead>                                        
                                        <tr role="row" class="filter">
                                            ...
                                            <td>{!! Form::select('degree_level_id', ['' => 'Select Degree Level']+$degreeLevels, null, array('id'=>'degree_level_id', 'class'=>'form-control')) !!}</td>
                                            <td><input type="text" class="form-control" name="degree_type" id="degree_type" autocomplete="off" placeholder="Degree Type"></td>
