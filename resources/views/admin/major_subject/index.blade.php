                                ...
                                <table class="table table-striped table-bordered table-hover"  id="majorSubjectDatatableAjax">
                                    <thead>                                        
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="major_subject" id="major_subject" autocomplete="off" placeholder="Major Subject"></td>
    ...
    $(function () {
        var oTable = $('#majorSubjectDatatableAjax').DataTable({
            ...
            ajax: {
                ...
                {data: 'major_subject', name: 'major_subject'}, {data: 'action', name: 'action', orderable: false, searchable: false}
            ]
        });
