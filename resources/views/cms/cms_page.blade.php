...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1 class="page-heading">{{$cmsContent->page_title}}</h1>
                    <p class="page_header_paragraph">Register an account with Coolbuffs, Start your first job posting /
                        Search job & send your resume / get Candidates CV.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid custom_padding_container_how_it_works">
            ...
            <div class="section howitwrap">
                ...
                <div class="titleTop">
                    ...
                    <p class="text-left w-100">Register an account with Coolbuffs, Start your first job posting / Search
                        job & send your resume / get Candidates CV.</p>
                </div>
                <!-- title end -->
                        ...
                        <div class="how_it_works_inner">
                            <div class="how_it_works_1">
                                ...
                                <p class="how_it_Works_custom_link mt-3">
                                    <a href="javascript:void(0);">Register Account</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="col-md-4 col-sm-4">
                        <div class="how_it_works_inner">
                            <div class="how_it_works_2">
                                <div class="iconcircle">
                                    <img src="<?php echo url("public/images/search_job.png");?>"
                                         class="how_works_icons">
                                </div>
                                <h4>{{__('Search Desired Job')}}</h4>
                                <p>After creating an account, You can easily search the jobs, save them make them
                                    favourite.</p>
                                <p class="how_it_Works_custom_link  mt-3">
                    ...
                    <li class="col-md-4 col-sm-4">
                        <div class="how_it_works_inner">
                            <div class="how_it_works_3">
                                <div class="iconcircle">
                                    <img src="<?php echo url("public/images/sebd_resume.png");?>"
                                         class="how_works_icons">
                                </div>
                                <h4>{{__('Send Your Resume')}}</h4>
                                <p>In Step 3, You can upload your latest Resume to the Job you are applying for. CV is
    ...
    <div class="userloginbox our_blog_container">
        <div class="container-fluid" style="padding: 0 100px 370px;">
            <div class="section howitwrap our_blog_post"></div>
        </div>
    </div>
