...
@section('content')
    ...
    @include('includes.inner_page_title', ['page_title'=>__('Submit Suggestions')])
                                ...
                                <div class="col-md-12">
                                    <div class="formrow{{ $errors->has('listing_url') ? ' has-error' : '' }}">
                                        ...
                                        @if ($errors->has('job_url'))
                                            <span class="help-block"> <strong>{{ $errors->first('job_url') }}</strong> </span>
                                        @endif </div>
                                </div>
                                <div class="col-md-12">
