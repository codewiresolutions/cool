        ...
        @if(isset($jobTitlesArray) && count($jobTitlesArray))
            ...
            @foreach($sortedJobTitles as $key => $jobTitle)
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($jobTitle) }} <span>{{ App\Job::countNumJobs('title', $jobTitle) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($skillIdsArray) && count($skillIdsArray))
            ...
            @foreach($jobSkills as $jobSkill)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($jobSkill->job_skill) }} <span>{{ App\Job::countNumJobs('job_skill_id', $jobSkill->job_skill_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($industryIdsArray) && count($industryIdsArray))
            ...
            @foreach($industries as $industry)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($industry->industry) }} <span>{{ App\Job::countNumJobs('industry_id', $industry->id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($functionalAreaIdsArray) && count($functionalAreaIdsArray))
            ...
            @foreach($functionalAreas as $functionalArea)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($functionalArea->functional_area) }} <span>{{ App\Job::countNumJobs('functional_area_id', $functionalArea->functional_area_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($careerLevelIdsArray) && count($careerLevelIdsArray))
            ...
            @foreach($careerLevels as $careerLevel)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($careerLevel->career_level) }} <span>{{ App\Job::countNumJobs('career_level_id', $careerLevel->career_level_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
...
{{--                    ->lang()--}}
{{--                    ->active()--}}
{{--                    ->orderBy('sort_order','DESC') // Order by the 'job_experience' column--}}
{{--                    ->get();--}}
{{--            @endphp--}}
            @foreach($data['job_experience'] as $jobExperience)
                @php
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title( $jobExperience->job_experience) }} <span>{{ App\Job::countNumJobs('job_experience_id', $jobExperience->job_experience_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{\Illuminate\Support\Str::title($jobType->job_type)}} <span>{{App\Job::countNumJobs('job_type_id', $jobType->job_type_id)}}</span> </li>
                @endif
                @endforeach
                @endif
            </ul>
        ...
        @if(isset($jobShiftIdsArray) && count($jobShiftIdsArray))
            ...
            @foreach($jobShifts as $jobShift)
                ...
                <li>
                    ...
                    {{\Illuminate\Support\Str::title( $jobShift->job_shift) }} <span>{{ App\Job::countNumJobs('job_shift_id', $jobShift->job_shift_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($degreeLevelIdsArray) && count($degreeLevelIdsArray))
            ...
            @foreach($degreeLevels as $degreeLevel)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($degreeLevel->degree_level) }} <span>{{ App\Job::countNumJobs('degree_level_id', $degreeLevel->degree_level_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($companyIdsArray) && count($companyIdsArray))
            ...
            @foreach($companies as $company)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($company->name) }} <span>{{ App\Job::countNumJobs('company_id', $company->id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($countryIdsArray) && count($countryIdsArray))
            ...
            @foreach($countries as $country)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($country->country) }} <span>{{ App\Job::countNumJobs('country_id', $country->country_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
        ...
        @if(isset($cityIdsArray) && count($cityIdsArray))
            ...
            @foreach($cities as $city)
                ...
                <li>
                    ...
                    {{ \Illuminate\Support\Str::title($city->city) }} <span>{{ App\Job::countNumJobs('city_id', $city->city_id) }}</span>
                </li>
            @endforeach
        @endif
    </ul>
 ...
 <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{\Illuminate\Support\Str::title($gender->gender)}} <span>{{App\Job::countNumJobs('gender_id', $gender->gender_id)}}</span> </li>
                @endif
                @endforeach
                @endif
            </ul>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{\Illuminate\Support\Str::title($state->state)}} <span>{{App\Job::countNumJobs('state_id', $state->state_id)}}</span> </li>
                @endif
                @endforeach
                @endif
            </ul>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                <li>
                    ...
                    {{\Illuminate\Support\Str::title($majorSubject->major_subject)}} <span>{{App\Job::countNumJobs('major_subject_id', $majorSubject->major_subject_id)}}</span> </li>
                @endif
                @endforeach
                @endif
            </ul>
