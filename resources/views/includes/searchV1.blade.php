                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <p class="right_talent">
                                    Looking For The Right Companies
                                </p>
                            </div>
                            <div class="col-lg-4">
                                @if(Auth::guard('company')->check())
                                    <a href="{{url('/job-seekers')}}">
                                        <input type="button" class="btn w-100 float-right right_talent_explore"
                                               value="Explore"/>
                                    </a>
                                @else
                                    <a href="{{url('/jobs')}}">
                                    ...
                                    @foreach ($specific_cpmpany_jobs as $key => $company_id_num_jobs)
                                        ...
                                        <div class="carousel-item <?php if($key==0){echo 'active';} ?>">
                                            <div class="col-lg-6 col-xl-4 col-md-6 p-0">
                                                <a href="{{route('job.detail', [$company_id_num_jobs->slug])}}"
                                                   title="{{$company_id_num_jobs->title}}">
