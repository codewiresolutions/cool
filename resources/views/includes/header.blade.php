<div class="header">
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-lg-3 col-md-12 col-12 mb-1 header_logo_padding_left">
                <a href="{{url('/')}}" data-turbolinks="false" class="logo mb-0 ml-8">
                    <img src="{{ asset('/') }}sitesetting_images/thumb/{{ $siteSetting->site_logo }}"
                         alt="{{ $siteSetting->site_name }}" class="desktop_logo"/>
                </a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            @if(!Auth::guard('company')->check())
                                <li class="nav-item {{ Request::url() == route('index') ? 'active' : '' }}">
                                    <a href="{{url('/')}}" data-turbolinks="false" class="nav-link">{{__('Home')}}</a>
                                </li>
                                @if(Auth::guard('company')->check())
                                    <li class="nav-item">
                                        <a href="{{url('/job-seekers')}}" class="nav-link">{{__('Seekers')}}</a>
                                    </li>
                                    <li class="nav-item {{ Request::url() == route('job.list') ? 'active' : '' }}">
                                        <a href="{{url('/jobs')}}" class="nav-link">{{__('Jobs')}}</a>
                                    </li>
                                @else
                                    <li class="nav-item {{ Request::url() == route('job.list') ? 'active' : '' }}">
                                        <a href="{{url('/jobs')}}" class="nav-link">{{__('Jobs')}}</a>
                                ...
                                <li class="nav-item {{ Request::url() == route('packages') ? 'active' : '' }}">
                                    <a href="{{url('/packages')}}" class="nav-link">{{__('Packages')}}</a>
                                </li>
                                ...
                                @foreach($show_in_top_menu as $top_menu)
                                    ...
                                    @if (isset($cmsContent->page_title) && $cmsContent->page_title != '')
                                        <li class="nav-item {{ Request::url() == route('cms', $top_menu->page_slug) ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::url() == route('blogs') ? 'active' : '' }}">
                                    <a href="{{ route('blogs') }}" class="nav-link">{{__('Blog')}}</a>
                                </li>
                            ...
                            @if(Auth::check() && !Auth::guard('company')->check())
                                <li class="nav-item dropdown userbtn">
                                    <a href="">{{Auth::user()->printUserImage()}}</a>
                            ...
                            @if(Auth::guard('company')->check())
                                <li class="nav-item postjob">
                                    <a href="{{route('post.job')}}" class="nav-link register">{{__('Post New Job')}}</a>
                                </li>
                                <li class="nav-item dropdown userbtn">
                                    <a href="">{{Auth::guard('company')->user()->company->printCompanyImage()}}</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('company.account') }}" class="nav-link">
                                                <i class="fa fa-user-circle" aria-hidden="true"></i>
                                                {{__('Account')}}
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{route('company.messages')}}" class="nav-link">
                                                <i class="fa fa-envelope-o" aria-hidden="true"></i> {{__('Messages')}}
                                            </a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            @if(!Auth::user() && !Auth::guard('company')->user())
                                <li class="nav-item {{ Request::url() == route('login') ? 'active' : '' }} {{ Request::url() == route('register') ? 'active' : '' }}">
                                    <a href="{{route('login')}}" class="nav-link">{{__('Sign in')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('register')}}"
                                       class="nav-link register">Register
                                    </a>
                                </li>
                            @endif
                            
                            
                            {{--                            <li class="dropdown userbtn"><a href="{{url('/')}}"><img src="{{asset('/')}}images/lang.png"--}}
                            {{--                                                                                     alt="" class="userimg"/></a>--}}
                            {{--                                <ul class="dropdown-menu">--}}
...
<style>
    .header {
        ...
        background-color: #fff; /* same as your header background */
