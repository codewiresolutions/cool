<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3"> 
    ...
    <ul class="optionlist view_more_ul title-list">
    ...
    <span class="text text-primary view_more" data-target=".title-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".title-list" style="display: none;">{{ __('View Less') }}</span>
</div>
    <!-- title end --> 
    ...
    <ul class="optionlist view_more_ul skill-list">
    ...
    <span class="text text-primary view_more" data-target=".skill-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".skill-list" style="display: none;">{{ __('View Less') }}</span>
</div>
        <!-- Jobs By Skill end --> 
    ...
    <ul class="optionlist view_more_ul industry-list">
    ...
    <span class="text text-primary view_more" data-target=".industry-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".industry-list" style="display: none;">{{ __('View Less') }}</span>
</div>
...
<div class="widget">
    ...
    <ul class="optionlist view_more_ul functional-list">
    ...
    <span class="text text-primary view_more" data-target=".functional-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".functional-list" style="display: none;">{{ __('View Less') }}</span>
</div>
<!-- Jobs by Functional areas end --> 
 ...
 <div class="widget">
    ...
    <ul class="optionlist view_more_ul career-list">
    ...
    <span class="text text-primary view_more" data-target=".career-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".career-list" style="display: none;">{{ __('View Less') }}</span>
</div>
    ...
    <span class="text text-primary view_less" data-target=".experience-list" style="display: none;">{{ __('View Less') }}</span>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul job-type-list">
            ...
            <span class="text text-primary view_more" data-target=".job-type-list">{{__('View More')}}</span>
            <span class="text text-primary view_less" data-target=".job-type-list" style="display: none;">{{ __('View Less') }}</span>
        <!-- Jobs By Job Type end --> 

        <!-- Jobs By Job Shift -->
        <div class="widget">
    <h4 class="widget-title">{{__('Jobs By Job Shift')}}</h4>
    <ul class="optionlist view_more_ul job-shift-list">
    ...
    <span class="text text-primary view_more" data-target=".job-shift-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".job-shift-list" style="display: none;">{{ __('View Less') }}</span>
</div>
<!-- Jobs By Job Shift end --> 
    ...
    <ul class="optionlist view_more_ul degree-list">
    ...
    <span class="text text-primary view_more" data-target=".degree-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".degree-list" style="display: none;">{{ __('View Less') }}</span>
</div>
...
<div class="widget">
    ...
    <ul class="optionlist view_more_ul company-list">
    ...
    <span class="text text-primary view_more" data-target=".company-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".company-list" style="display: none;">{{ __('View Less') }}</span>
</div>
        <!-- Top Companies end --> 
    ...
    <ul class="optionlist view_more_ul country-list">
    ...
    <span class="text text-primary view_more" data-target=".country-list">{{__('View More')}}</span>
    <span class="text text-primary view_less" data-target=".country-list" style="display: none;">{{ __('View Less') }}</span>
</div>
        <!-- Jobs By Country end--> 
