    ...
    <div class="container-fluid subscribe_custom_pafdding">
        ...
        <div class="row subscribe_custom_container m-0">
            ...
            <div class="col-lg-12">
                ...
                <p>By Entering your email address, you are agreeing to receive marketing emails from Coolbuffs Job
                    Portal. You will receive the latest information about portal. Subscribe to receive our offers in
                    preview.</p>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-8" style="margin: 0 auto;">
                ...
                <form method="post" action="{{ route('subscribe.newsletter')}}" name="subscribe_newsletter_form"
                      id="subscribe_newsletter_form">
                    {{ csrf_field() }}


                    <div class="input-group">
                        <!-- <input type="text" class="form-control" placeholder="{{__('Name')}}" name="name" id="name" required="required"> -->
                        <input type="text" class="form-control subscribed_input_email"
                               placeholder="Enter Your Email Here ...." name="email" id="email" required="required">
                        <div class="input-group-append custom_width_100_percentage">
                            <button class="btn btn-default subscribed_input_button" type="button"
                                    id="send_subscription_form">{{__('Subscribe')}}</button>
                        </div>
                    </div>
