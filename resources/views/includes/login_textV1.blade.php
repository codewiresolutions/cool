    ...
    <div class="container-fluid custom_padding_container_how_it_works">
        <div class="section howitwrap">
            ...
            <div class="titleTop">
                ...
                <p class="text-left w-100">Register an account with Coolbuffs, Start your first job posting / Search job
                    & send your resume / get Candidates CV.</p>
            </div>
            <div class="row g-4">
                <!-- title end -->
                <ul class="howlist row">
                    <!-- Step 1 -->
                    <li class="col-md-4 col-sm-6 d-flex">
                        <div class="how_it_works_inner d-flex flex-column">
