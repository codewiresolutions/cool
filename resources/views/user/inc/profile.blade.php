...
<div class="row">
    <div class="col-md-6">
        <div class="formrow">
            ...
            {{ ImgUploader::print_image("user_images/$user->cover_image", 120, 50) }}
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'passport_expiry') !!}">
            ...
            {!! Form::date('passport_expiry', old('passport_expiry'), [
                'class' => 'form-control',
                'id' => 'passport_expiry',
        ...
        <div class="formrow">
            ...
            <div class="input-group">
                ...
                {!! Form::text('mobile_num', null, [
                    ...
                    'aria-describedby' => 'mobile_prefix',
                ]) !!}
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12" id="video_link_id">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'video_link') !!}">
            <label for="">{{ __('Sample Video') }} - <a
                    href="<?= url('https://www.youtube.com/watch?v=gyFaBZ_BQhc') ?>">https://www.youtube.com/watch?v=gyFaBZ_BQhc</a>
            </label>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'notice_period') !!}">
            <label for="">{{ __('Notice Period') }}<span style="color:red"> *</span></label>
            {!! Form::select(
                'notice_period',
                [
                    '' => __('Select Notice Period'),
                    30 => '30 Days', // Use integers
                    60 => '60 Days',
                    90 => '90 Days',
                ],
                null,
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="formrow">
            <button type="submit" class="btn">{{ __('Save Personal Information') }} <i
