<div class="modal-body">
    ...
    <div class="form-body">
        ...
        <div class="formrow" id="div_institution">
            ...
            <input class="form-control" id="institution" placeholder="{{__('Institution')}}" name="institution"
                   type="text"
                   value="{{ isset($resume_data['education']['edu_title']) ? trim($degree_institution,' ') : (isset($profileEducation) ? $profileEducation->institution : '') }}">
        ...
        <div class="formrow" id="div_date_completion">
            ...
            ?>
            @if($result)
                {!! Form::select('date_completion', [''=>__('Select Date of Completion')]+MiscHelper::getEstablishedIn(), $result, array('class'=>'form-control', 'id'=>'date_completion')) !!}
            @else
                {!! Form::select('date_completion', [''=>__('Select Date of Completion')]+MiscHelper::getEstablishedIn(), $date_completion, array('class'=>'form-control', 'id'=>'date_completion')) !!}
            @endif
        ...
        <div class="row">
            ...
            <div class="formrow col-md-6" id="div_result_type_id">
                <?php
            ...
            <div class="formrow col-md-6" id="div_degree_result">
                <input class="form-control" id="degree_result" placeholder="{{__('Degree Result')}}"
                       name="degree_result" type="text"
                       value="{{(isset($profileEducation)? $profileEducation->degree_result:'')}}">
