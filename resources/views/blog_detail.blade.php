                                ...
                                <div class="comment-item" id="comment-{{ $comment->id }}">
                                    ...
                                    <div class="comment-body w-100">
                                        <div class="comment-author">
                                            {{ $comment->user->name }}
                                            <span
                                                class="comment-meta ml-2">{{ $comment->created_at->diffForHumans() }}</span>
                                        </div>
                                        ...
                                        <div class="comment-meta mt-2">
                                            ...
                                            <button type="button"
                                                class="btn btn-link btn-sm p-0 reply-toggle text-decoration-none"
                                            ...
                                            <form class="ajax-reply-form">
                                                ...
                                                <div class="mt-2 text-right">
                                                    <button type="submit" class="btn btn-primary btn-sm">Post
                                                        Reply</button>
                                                    <button type="button"
                                                        class="btn btn-light btn-sm reply-cancel ml-2">Cancel</button>
                                                </div>
                                            </form>
                                        </div>
