...
<body>  <table>
        <tr>
            ...
            <td style="width: 300pt; text-align:right;"><table style="border: 1px solid black;">
    ...
    <tr>
        ...
        <tr>
                ...
                @if(count($user_experience) > 0)<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">EXPERIENCE<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="765" alt="" style="line-height: 1;"> </p><table>
...
<tr>
  @if(count($user_educations) > 0)<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">EDUCATION<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="1300" alt="" style="line-height: 1;"> </p><table>
      
                                  @foreach($user_educations as $user_edu)
                    <tr><td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user_edu->institution .', '. $user_edu->city }}</p></td></tr>
                    <tr><td><p style="font-size: 11pt; color:#007FFF; margin:0; padding:0;">{{ $user_edu->degree_level}}</p></td>
                    <td style="width:60px"><p style="font-size: 9pt; font-align:right; margin:0; padding:0;">{{ $user_edu->date_completion}}</p></td></tr>
                    <tr><td></td></tr>
...
<tr>
  @if(count($user_projects) > 0)<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">PROJECTS<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="1300" alt="" style="line-height: 1;"> </p><table>
  @foreach($user_projects as $project)
                            <tr><td><table><tr><td><p style="font-size: 11pt; margin:0; padding:0;">{{ $project->name }}</p></td><td style=" width:150pt;"><p style="font-size: 9pt; line-height:1;">{{ date('M, Y', strtotime($project->date_start)) . ' - ' . date('M, Y', strtotime($project->date_end)) }}</p></td></tr></table></p></td></tr>
                            <tr><td><p style="font-size: 11pt; color:#007FFF; margin:0; padding:0;">{{ $project->url }}</p></td></tr>
                            <tr><td></td></tr>
                ...
                <tr>
  @if(count($user_languages) > 0)<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">SKILLS<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="1300" alt="" style="line-height: 1;"> </p><ul style="padding: 0; margin:0;">
  
  @foreach($user_skills as $user_skill)<li  style="padding: 0pt; margin:0pt; line-height:1;"><p style="font-size: 11pt; line-height:1; margin:0pt; padding:0pt;">{{ $user_skill->job_skill }} - <span style="color:#007FFF;">{{ $user_skill->job_experience }}</span></p></li>@endforeach</ul><table>
  ...
  @if (isset($user->father_name) ||
                ...
                isset($user->video_link))<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">PERSONAL INFORMATION<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="1300" alt="" style="line-height: 1;"> </p><table>
                @isset($user->father_name)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Father Name :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->father_name }}</p></td>
                    </tr>
                @endisset
                @isset($user->date_of_birth)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Date of Birth :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ date('d F, Y', strtotime($user->date_of_birth)) }}</p></td>
                    </tr>
                @endisset
                @isset($user->gender_id)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Gender :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->gender }}</p></td>
                    </tr>
                @endisset
                @isset($user->marital_status)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Marital Status :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->marital_status }}</p></td>
                    </tr>
                @endisset
                @isset($user->nationality)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Nationality :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->nationality }}</p></td>
                    </tr>
                @endisset
                @isset($user->job_experience)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Job Experience :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->job_experience }}</p></td>
                    </tr>
                @endisset
                @isset($user->industry)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Industry :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->industry }}</p></td>
                    </tr>
                @endisset
                @isset($user->functional_area)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Functional Area :</p></td>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">{{ $user->functional_area }}</p></td>
                    </tr>
                @endisset
                @isset($user->video_link)
                    <tr>
                        <td><p style="font-size: 11pt; margin:0; padding:0;">Video Profile :</p></td>
  ...
  @if(count($user_languages) > 0)<p style="font-size: 16px; font-family:serif; line-height:1; padding:0; margin:0;">LANGUAGES<img src="{{asset('/word-icons/word6-border-1.png')}}" height="5" width="1300" alt="" style="line-height: 1;"> </p><ul style="padding: 0; margin:0;">
  
  @foreach($user_languages as $user_language)<li  style="padding: 0pt; margin:0pt; line-height:1;"><p style="font-size: 11pt; line-height:1; margin:0pt; padding:0pt;">{{ $user_language->lang }} - <span style="color:#007FFF;">{{ $user_language->language_level }}</span></p></li>@endforeach</ul>
