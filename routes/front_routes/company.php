<?php
Route::get('company-packages', 'Company\CompanyController@companyPackages')->name('company.packages');
...
Route::get('company-account', 'Admin\CompanyController@account')->name('company.account');
Route::post('change-company-password', 'Admin\CompanyController@changePassword')->name('change-password.company');

Route::get('company-users/create', 'Company\UserController@create')->name('company.users.create');
Route::get('company-users/edit/{companyUser}', 'Company\UserController@edit')->name('company.users.edit');
Route::get('company-users', 'Company\UserController@index')->name('company.users.index');
Route::post('company-users', 'Company\UserController@store')->name('company.users.store');
Route::put('company-users/{companyUser}', 'Company\UserController@update')->name('company.users.update');
Route::delete('company-users/{companyUser}', 'Company\UserController@destroy')->name('company.users.destroy');
Route::get('/invite/accept/{id}', 'Company\UserController@acceptInvite')->name('company-users.accept-invite')->middleware('signed');
Route::post('/invite/accept/{id}', 'Company\UserController@completeInvite')->name('company-users.complete-invite');
